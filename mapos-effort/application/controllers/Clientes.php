    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            $data = [
                ...
                'qntBlocos' => set_value('qntBlocos'),
                'qntApartamentos' => set_value('qntApartamentos'),
                'qntAndares' => set_value('qntAndares'),
                'nomeSindico' => set_value('nomeSindico'),
                'nomeAdministradora' => set_value('nomeAdministradora'),
                'nomeRespAdministradora' => set_value('nomeRespAdministradora'),
                'cep' => set_value('cep'),
