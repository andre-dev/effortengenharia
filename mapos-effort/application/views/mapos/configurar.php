                        ...
                        <div class="control-group">
                            <div class="span8">
                                ...
                                <div class="span10">
                                    ...
                                    <label> <input <?= @in_array("Em Andamento", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Contrato"> <span class="lbl"> Contrato</span> </label> <!-- Em Andamento -->
