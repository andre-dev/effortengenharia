...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `qntBlocos` VARCHAR(45) NULL DEFAULT NULL,
  `qntApartamentos` VARCHAR(45) NULL DEFAULT NULL,
  `qntAndares` VARCHAR(45) NULL DEFAULT NULL,
  `nomeSindico` VARCHAR(45) NULL DEFAULT NULL,
  `nomeAdministradora` VARCHAR(45) NULL DEFAULT NULL,
  `nomeRespAdministradora` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `os` (
  ...
  `descricaoProduto` LONGTEXT NULL DEFAULT NULL,
